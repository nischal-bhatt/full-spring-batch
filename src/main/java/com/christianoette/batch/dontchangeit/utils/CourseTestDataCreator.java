...
public class CourseTestDataCreator {
    ...
    private static final int NR_OF_FILES = 1;
    ...
    private static List<String> LAST_NAMES = List.of("AndyOngKahSong", "Lee", "Smith", "Khan", "Nguyen", "Shah", "Chen", "Fox", "Gill", "Burke", "Potter", "Carvalho", "Sanchez", "Liu", "Aziz", "Mueller", "Lang", "Wolf", "Small", "Michael", "Knox", "Winters", "Sommers", "Spring");
